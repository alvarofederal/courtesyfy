    ...
    >
      ...
      <div className="relative z-10 flex justify-center mb-10">
        <Link href="/">
          <span
            ...
            style={{ fontFamily: "var(--font-open-sans), 'Open Sans', sans-serif", fontSize: "24px" }}
          >
      ...
      <div className="relative z-10 flex justify-center mb-8">
        <div className="flex items-center gap-2 text-xs" style={{ color: "rgba(255,255,255,0.35)" }}>
          ...
          <span className="w-8 h-px mx-1" style={{ background: "rgba(255,255,255,0.15)" }} />
          <span
            className="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold text-black"
            style={{ background: "#10b981" }}
          >2</span>
          <span style={{ color: "rgba(255,255,255,0.70)" }}>Configure sua loja</span>
          <span className="w-8 h-px mx-1" style={{ background: "rgba(255,255,255,0.15)" }} />
          <span
            className="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold"
            style={{ background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.15)", color: "rgba(255,255,255,0.40)" }}
          >3</span>
          <span>Primeira campanha</span>
        </div>
      </div>

      {/* Card */}
      <div
        className="relative z-10 w-full max-w-4xl mx-auto rounded-3xl p-6 sm:p-8"
        style={{

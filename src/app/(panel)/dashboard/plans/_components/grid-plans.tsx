    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50 p-4 sm:p-6 lg:p-8">
      <div className="mx-auto space-y-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2 text-lg">Selecione o plano ideal para suas necessidades</p>
        </div>
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {subscriptionPlans.map((plan, index) => (
            <Card 
              key={plan.id} 
              className={cn(
                "relative border-2 shadow-lg transition-all hover:shadow-xl",
                index === 1 
            ...
            >
              ...
              <CardFooter className="pt-6">
                <SubscriptionButton 
                  type={plan.id === "FREE" ? "FREE" : "PROFESSIONAL"}
                />    
              </CardFooter>
            </Card>
          ))}
